...
Estado actualizado: 2026-06-06 05:07 CEST.
...
- Comparador CV avanzado: la comparación muestra diff visual por campo; faltan resaltado inline palabra a palabra y enlaces directos para editar la versión adaptada.
