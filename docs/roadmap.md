...
Estado actualizado: 2026-06-06 07:11 CEST.
...
- Permisos por acción: existe matriz de permisos y guard granular aplicado a `/users` y `/analytics`; falta extenderlo al resto de endpoints admin.
