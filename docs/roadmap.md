...
Estado actualizado: 2026-06-06 18:04 CEST.
...
- Versiones CV UI avanzada: el JSON estructurado ya se puede editar con validación semántica mínima, confirmación para cambios grandes, preservacion de campos ricos al aplicar listas simples, bloques de resumen/skills/idiomas/proyectos/educación/certificaciones/experiencia/secciones, formularios granulares de experiencia/skills/proyectos, borrador/revision/publicacion para `structuredJson` y draft/publish de metadatos no JSON; faltan formularios granulares para educación y certificaciones.
- Editor CV por bloques: el editor principal está conectado a campos básicos y Versiones CV ya tiene bloques de resumen/skills/idiomas/proyectos/educación/certificaciones/experiencia/secciones, duplicado de versiones y edición granular de una experiencia, una skill y un proyecto; falta duplicado por bloque y granularidad equivalente en multiples experiencias/resto de bloques.
...
1. Formularios granulares para educacion/certificaciones en Versiones CV.
