...
Estado actualizado: 2026-06-06 17:10 CEST.
...
- Skills UI avanzada: el CRUD está conectado con confirmación modal de borrado, edición completa por dialogo, gestion de categorias, selector de niveles y reordenado por botones; faltan drag/drop y draft/publish desde UI.
...
- Publicación por entidad CMS: existe workflow granular real para tema visual, perfil público, experiencias, proyectos y skills; falta extenderlo a educación, certificaciones y CV.
- Restauración por entidad CMS: existe restore para tema visual, perfil público, experiencias, proyectos y skills; falta restaurar educación, certificaciones y CV cuando entren al workflow draft/publish.
...
1. UI draft/publish para skills.
2. Extender draft/publish API a educacion y certificaciones.
