...
Estado actualizado: 2026-06-06 12:37 CEST.
...
- Versiones CV UI avanzada: el JSON estructurado ya se puede editar con validación semántica mínima, confirmación para cambios grandes y bloques de resumen/skills/idiomas/proyectos/educación/certificaciones/experiencia; faltan secciones personalizadas y formularios avanzados por bloque.
- Editor CV por bloques: el editor principal está conectado a campos básicos y Versiones CV ya tiene bloques de resumen/skills/idiomas/proyectos/educación/certificaciones/experiencia; faltan secciones personalizadas, duplicado de bloques y edición granular de responsabilidades/logros.
