...
Los previews A4 web pueden renderizar varias hojas con `data-cv-preview-pages`, `data-page-index` y `data-page-count`, manteniendo cada hoja con ratio A4 y scroll horizontal estable en pantallas moviles.
