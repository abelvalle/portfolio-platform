...
async function seedPageSectionsAndModules() {
  ...
  const translations = [
    ...
    ["es", "public.sections", "0.label", "Sobre mi"],
    ["es", "public.sections", "1.label", "Experiencia"],
    ["es", "public.sections", "2.label", "Proyectos"],
    ["es", "public.sections", "3.label", "Estudios"],
    ["es", "public.sections", "4.label", "Skills"],
    ["es", "public.sections", "5.label", "Contacto"],
    ...
    ["en", "public.sections", "0.label", "About"],
    ["en", "public.sections", "1.label", "Experience"],
    ["en", "public.sections", "2.label", "Projects"],
    ["en", "public.sections", "3.label", "Education"],
    ["en", "public.sections", "4.label", "Skills"],
    ["en", "public.sections", "5.label", "Contact"],
