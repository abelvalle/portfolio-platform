...
export function IntroScreen({ name, subtitle, onEnter }: IntroScreenProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        <p className="font-mono text-sm uppercase tracking-[0.28em] text-muted-foreground">Portfolio / CV</p>
